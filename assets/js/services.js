...
var ApplicationDbContext = {
    ...
    "findIndexStickyNoteById": function(id) {
        ...
        console.log("findIndexSticky note service"+data)
        if(data == null) {
            console.log("findIndexSticky note service data == null")
            return -1;
        }
       
        const snFromDB = this.getStickyNoteById(id);
        if(snFromDB == null) {
            console.log("findIndexSticky sn from db  == null" + snFromDB)
            return -1;
        }
    ...
    "updateStickyNote": function(stickyNote) {
        ...
        console.log('update sticky note service  ' + stickyNote)     
        ...
        console.log('corect index')
        this._dbData.stickynotes[index] = stickyNote;
       // console.log(this._dbData.stickynotes[modifiedDate])
       // this._dbData.stickynotes[modifiedDate]= new Date().getTime();
        this.save();
        return true;
    },
